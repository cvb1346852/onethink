...
<div id="main-container" class="container">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo ($model["title"]); ?></strong></h3>
        <div class="noticeDetailInfo">发布者:<?php echo ($model["name"]); ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d H:i',$model['create_time']);?></div>
        <img  src="<?php echo ($model["path"]); ?>" width="400px"/>
