...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<select name="type">
					<option value="0" <?php if(($info["type"]) == "0"): ?>selected<?php endif; ?>>售卖</option>
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="name" value="<?php echo ((isset($info["type"]) && ($info["type"] !== ""))?($info["type"]):''); ?>">
			</div>
		</div>
